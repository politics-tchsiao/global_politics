...
\vspace{1em}
\begin{center}
\Large{Welcome to enroll Global Politics !}
\end{center}
\end{frame}
\begin{frame}{Course Information}
\begin{itemize}
\item Instructor: Tzu-Chi Hsiao.
\item Course: Global Politics.
\item Credit: 2.
...
\begin{itemize}
\item Based on comparative politics, we learn different aspects of global politics.
\item But we feel sad that we have no idea about the theoratically in comparative politics.
\item So we take this course to learn the theoratically of global politics.
\end{itemize}
\end{frame}
...
Main book: Global Politics, Newest\textsuperscript{th} edition by Andrew Heywood. \\
\end{frame}
